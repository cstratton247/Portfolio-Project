...
Since the idea I pitched was a terrain generator, I decided that the most important aspect would be biome generation, as many of the heights would be based on the biome and so would the terrain structures.
